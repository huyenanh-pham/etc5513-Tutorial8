...
\includegraphics{Report_files/figure-latex/covid-s1-1.pdf}

\hypertarget{section-2}{%
\section{Section 2}\label{section-2}}

\includegraphics{Report_files/figure-latex/a-1.pdf}
...
{\centering \includegraphics{Report_files/figure-latex/France-Sweden-1} 

}

\caption{Rates of covid cases over time for selected countries}\label{fig:France-Sweden}
\end{figure}
